<html> <!--hi -->
    <head>
        <title>mindlab</title> 
        <link rel="stylesheet" href="api/style.css?v=<?php echo time(); ?>">
            ...
            <div class="navbar">
                <a href="/api/index.php" id="mindlab_logo">mindlab.</a>
                    <ul> 
                        ...
                        <li><a href="api/community.html">community.</a></li>
            ...
            <div class="btqcontent">
                ...
                <p class="btqtextp"> 
                    so you're ready to begin huh?
                     ...
                     <br><br><br>for now you must remain patient. 
                     <br>
                     <br> <br> 
                 ...
                 <form id="email" action="join.php" method="post">
                 <div class="inputbox">
                    <input type="email" name="emailsub" required="required">
                    <button type="submit" name="emailsubbtn" class= "submitbtn">join</button>
                    <a class="email">enter email</a>
                    <div class="success-message" style="display:none">you're signed up! &#127881;</div>
                    <i></i>
                </div>
            </form>
             </div>   
